...
async function seedFinancialData() {
    try {
        ...
        const financialInvestRepository = config_database_1.AppDataSource.getRepository(financial_invest_entities_1.FinancialInvest);
        ...
        const financialAnalysis = await config_database_1.AppDataSource.manager.query(`
      SELECT 
        e.evidence_id,
        e.description,
        e.status,
