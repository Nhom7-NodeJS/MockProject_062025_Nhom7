...
<<<<<<<< HEAD:src/migrations/1751935395820-createdb.ts
export class Createdb1751935395820 implements MigrationInterface {
    name = 'Createdb1751935395820'
========
export class CreateDb1171752218658817 implements MigrationInterface {
    name = 'CreateDb1171752218658817'
>>>>>>>> origin/dev3:src/migrations/1752218658817-create-db-11-7.ts
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`roles\` (\`role_id\` varchar(255) NOT NULL, \`description\` enum ('Patrol Officer', 'Censor', 'Investigator', 'Police Chief', 'Forensic Officer', 'Financial Investigator') NOT NULL, \`is_deleted\` tinyint NOT NULL DEFAULT 0, PRIMARY KEY (\`role_id\`)) ENGINE=InnoDB`);
<<<<<<<< HEAD:src/migrations/1751935395820-createdb.ts
        await queryRunner.query(`CREATE TABLE \`cases_users\` (\`case_id\` varchar(255) NOT NULL, \`user_id\` varchar(255) NOT NULL, \`is_deleted\` tinyint NOT NULL DEFAULT 0, \`notes\` text NULL, \`assigned_at\` timestamp NOT NULL, PRIMARY KEY (\`case_id\`, \`user_id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`users\` (\`username\` varchar(255) NOT NULL, \`password_hash\` varchar(255) NOT NULL, \`fullname\` varchar(255) NOT NULL, \`avatar_url\` varchar(255) NULL, \`phone_number\` varchar(255) NULL, \`dob\` timestamp NOT NULL, \`date_attended\` timestamp NOT NULL, \`status\` enum ('active', 'inactive') NOT NULL, \`create_at\` timestamp NOT NULL, \`is_deleted\` tinyint NOT NULL DEFAULT 0, \`refresh_token\` varchar(255) NULL, \`role_id\` varchar(255) NULL, PRIMARY KEY (\`username\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`reports\` (\`report_id\` varchar(255) NOT NULL, \`crime_type\` enum ('Crimes Against Persons', 'Crimes Against Property', 'White-Collar Crimes', 'Cyber Crimes', 'Drug-related Crimes', 'Public Order Crimes') NOT NULL, \`severity\` enum ('Minor', 'Moderate', 'Serious', 'Critical') NOT NULL, \`incident_date\` timestamp NOT NULL, \`description\` varchar(255) NULL, \`case_location\` varchar(255) NOT NULL, \`reported_at\` timestamp NOT NULL, \`reporter_location\` varchar(255) NOT NULL, \`reporter_fullname\` varchar(255) NOT NULL, \`reporter_email\` varchar(255) NOT NULL, \`reporter_phone_number\` varchar(255) NULL, \`is_deleted\` tinyint NOT NULL DEFAULT 0, \`status\` enum ('Approved', 'Pending', 'Rejected') NOT NULL, \`reporter_incident_relationship\` enum ('Victim', 'Witness', 'Bystander') NOT NULL, \`case_id\` varchar(255) NULL, \`user_id\` varchar(255) NULL, PRIMARY KEY (\`report_id\`)) ENGINE=InnoDB`);
...
<<<<<<<< HEAD:src/migrations/1751935395820-createdb.ts
        ...
        await queryRunner.query(`CREATE TABLE \`warrants\` (\`warrant_id\` varchar(255) NOT NULL, \`warrant_name\` varchar(255) NOT NULL, \`attached_file\` json NULL, \`time_publish\` timestamp NOT NULL, \`is_deleted\` tinyint NOT NULL DEFAULT 0, \`deadline\` timestamp NOT NULL, \`status\` enum ('Waiting executing', 'Executing', 'Completed') NOT NULL DEFAULT 'Waiting executing', \`case_id\` varchar(255) NULL, PRIMARY KEY (\`warrant_id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`evidences\` (\`evidence_id\` varchar(255) NOT NULL, \`description\` varchar(255) NULL, \`collected_at\` timestamp NOT NULL, \`current_location\` varchar(255) NOT NULL, \`attach_file\` varchar(255) NOT NULL, \`status\` varchar(255) NOT NULL, \`is_deleted\` tinyint NOT NULL DEFAULT 0, \`evidence_type\` enum ('Physical Evidence', 'Biological Evidence', 'Trace Evidence', 'Documentary Evidence', 'Digital Evidence') NOT NULL, \`case_id\` varchar(255) NULL, \`report_id\` varchar(255) NULL, \`user_id\` varchar(255) NULL, \`warrant_id\` varchar(255) NULL, PRIMARY KEY (\`evidence_id\`)) ENGINE=InnoDB`);
========
