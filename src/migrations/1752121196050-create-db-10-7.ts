...
export class CreateDb1071752121196050 implements MigrationInterface {
    name = 'CreateDb1071752121196050'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`users\` (\`username\` varchar(255) NOT NULL, \`password_hash\` varchar(255) NOT NULL, \`fullname\` varchar(255) NOT NULL, \`avatar_url\` varchar(255) NULL, \`phone_number\` varchar(255) NULL, \`gender\` enum ('male', 'female', 'unknown') NULL DEFAULT 'unknown', \`dob\` timestamp NOT NULL, \`date_attended\` timestamp NOT NULL, \`status\` enum ('active', 'inactive') NOT NULL, \`create_at\` timestamp NOT NULL, \`is_deleted\` tinyint NOT NULL DEFAULT 0, \`refresh_token\` varchar(255) NULL, \`role_id\` varchar(255) NULL, PRIMARY KEY (\`username\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`witnesses\` (\`witness_id\` varchar(255) NOT NULL, \`fullname\` varchar(255) NOT NULL, \`contact\` varchar(255) NOT NULL, \`national\` varchar(255) NULL, \`gender\` enum ('male', 'female', 'unknown') NULL DEFAULT 'unknown', \`statement\` varchar(255) NOT NULL, \`is_deleted\` tinyint NOT NULL DEFAULT 0, \`case_id\` varchar(255) NULL, PRIMARY KEY (\`witness_id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`victims\` (\`victim_id\` varchar(255) NOT NULL, \`fullname\` varchar(255) NULL, \`contact\` varchar(255) NOT NULL, \`national\` varchar(255) NULL, \`gender\` enum ('male', 'female', 'unknown') NULL DEFAULT 'unknown', \`description\` varchar(255) NULL, \`injuries\` varchar(255) NOT NULL, \`status\` varchar(255) NOT NULL, \`is_deleted\` tinyint NOT NULL DEFAULT 0, \`case_id\` varchar(255) NULL, PRIMARY KEY (\`victim_id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`suspects\` (\`suspect_id\` varchar(255) NOT NULL, \`fullname\` varchar(255) NULL, \`national\` varchar(255) NULL, \`gender\` enum ('male', 'female', 'unknown') NOT NULL, \`dob\` timestamp NOT NULL, \`identification\` varchar(255) NOT NULL, \`phone_number\` varchar(255) NOT NULL, \`description\` varchar(255) NOT NULL, \`address\` varchar(255) NOT NULL, \`catch_time\` timestamp NOT NULL, \`notes\` varchar(255) NULL, \`status\` varchar(255) NOT NULL, \`mugshot_url\` varchar(255) NULL, \`fingerprints_hash\` varchar(255) NOT NULL, \`health_status\` varchar(255) NOT NULL, \`report_id\` varchar(255) NULL, PRIMARY KEY (\`suspect_id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`cases\` (\`case_id\` varchar(255) NOT NULL, \`case_name\` varchar(255) NOT NULL, \`type_case\` enum ('Robbery', 'Murder', 'Rape') NOT NULL, \`severity\` enum ('Low', 'Medium', 'High', 'Critical') NOT NULL, \`status\` enum ('Pending Approval', 'In Process', 'Done') NOT NULL, \`summary\` varchar(255) NULL, \`create_at\` timestamp NOT NULL, \`is_deleted\` tinyint NOT NULL DEFAULT 0, PRIMARY KEY (\`case_id\`)) ENGINE=InnoDB`);
