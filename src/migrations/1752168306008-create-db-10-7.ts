...
export class CreateDb1071752168306008 implements MigrationInterface {
    name = 'CreateDb1071752168306008'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`witnesses\` (\`witness_id\` varchar(255) NOT NULL, \`fullname\` varchar(255) NOT NULL, \`contact\` varchar(255) NOT NULL, \`national\` varchar(255) NULL, \`gender\` enum ('male', 'female', 'unknown') NULL, \`statement\` varchar(255) NOT NULL, \`is_deleted\` tinyint NOT NULL DEFAULT 0, \`case_id\` varchar(255) NULL, PRIMARY KEY (\`witness_id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`victims\` (\`victim_id\` varchar(255) NOT NULL, \`fullname\` varchar(255) NULL, \`contact\` varchar(255) NOT NULL, \`national\` varchar(255) NULL, \`gender\` enum ('male', 'female', 'unknown') NULL, \`description\` varchar(255) NULL, \`injuries\` varchar(255) NOT NULL, \`status\` varchar(255) NOT NULL, \`is_deleted\` tinyint NOT NULL DEFAULT 0, \`case_id\` varchar(255) NULL, PRIMARY KEY (\`victim_id\`)) ENGINE=InnoDB`);
